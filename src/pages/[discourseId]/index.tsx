                                ...
                                <>
                                    ...
                                    <div className="flex flex-col gap-2 bg-card rounded-xl p-4">
                                        ...
                                        <div className='flex items-center gap-1 mt-2'>
                                            ...
                                            <div className='flex flex-col'>
                                                <a href={`https://twitter.com/${u1?.screen_name}`} className='hover:text-white/60 text-white/30 text-xs tracking-wide font-medium'>{u1?.name}</a>
                                                <a href={`https://twitter.com/${u2?.screen_name}`} className='hover:text-white/60 text-white/30 text-xs tracking-wide font-medium'>{u2?.name}</a>
                                            </div>
                                        </div>
